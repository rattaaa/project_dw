...
def main(dataset_id, table_id, file_path):
    ...
    keyfile = "../credentials/dataengineer-swu-ds525-load-data-to-bigquer-415510-fb75e6d302e3.json"
    service_account_info = json.load(open(keyfile))
    credentials = service_account.Credentials.from_service_account_info(service_account_info)

    # โค้ดส่วนนี้จะเป็นการสร้าง Client เชื่อมต่อไปยังโปรเจค GCP ของเรา โดยใช้ Credentials ที่
    # สร้างจากโค้ดข้างต้น
    project_id = "dataengineer-415510"
...
if __name__ == "__main__":
    ...
    with open("github_detail.csv", "w") as csv_file:
    ...
    main(dataset_id="github", table_id="events", file_path="github_detail.csv")
...
def main(dataset_id, table_id, file_path):
    ...
    job_config = bigquery.LoadJobConfig(
        ...
        schema=[
            ...
            bigquery.SchemaField("display_login", bigquery.SqlTypeNames.STRING),
...
if __name__ == "__main__":
    ...
    main(dataset_id="github", table_id="actor", file_path="github_detail.csv")
...
if __name__ == "__main__":
    ...
    main(dataset_id="github", table_id="repo", file_path="github_detail.csv")
